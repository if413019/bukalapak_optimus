...
public class BaseScreen {
    ...
    public BaseScreen(AppiumDriver driver) {
        this.driver = driver;
        System.out.println("isi driver:" +driver);
...
//    }
    ...
    public void scrollDownToThenTap(String text){
        By byOfElementToBeFound = By.xpath("//*[@text=\"" + text + "\"]");
        scrollDownTo(byOfElementToBeFound);
        List<WebElement> elements = driver.findElements(byOfElementToBeFound);
    ...
    protected void clickElementOnIndex(By by, int index){
